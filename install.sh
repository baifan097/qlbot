...
gitPull(){
    ...
    cd /ql/data/repo && git clone ${daili}https://github.com/gd0772/qlbot.git
    cp -a /ql/data/repo/qlbot/* /ql/data/jbot && cp -a /ql/data/jbot/conf/* /ql/data/config && cp -a /ql/data/jbot/jk_script/* /ql/data/scripts
